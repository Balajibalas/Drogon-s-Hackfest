...
import 'package:supervisor/AddWorkerPage.dart'; // Import the new page
              ...
              onTap: () {
                showDialog(
                  ...
                  builder: (context) {
                    return AlertDialog(
                      title: Text('About'),
                      content: Text('SafeMineLog Supervisor is a safety management app developed by the team Ctrl+N for SIH'),
                      actions: [
                        TextButton(
